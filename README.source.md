...
Read [CONTRIBUTING.md](CONTRIBUTING.md) before contributing, use [SUPPORT.md](SUPPORT.md) when
requesting help, and report vulnerabilities according to [SECURITY.md](SECURITY.md). Accepted
roadmap work is tracked in [`.planfs`](.planfs).

`README.md` is generated from this file and compile-checked snippets in
