...
| --- | --- | --- |
| RazorLight library | `Dijgrid.RazorLight` | `3.0.0-beta.3` |
| Optional HTML integration | `Dijgrid.RazorLight.Html` | `3.0.0-beta.3` |
| Precompile tool | `Dijgrid.RazorLight.Precompile` | `3.0.0-beta.3` |
...
pwsh ./scripts/Test-PackageConsumer.ps1 -PackageDirectory artifacts/packages -Version 3.0.0-beta.3
```
...
5. Create an annotated tag whose version exactly matches the evaluated project `Version`, then push
   ...
   ```shell
   git tag -a v3.0.0-beta.3 -m "RazorLight 3.0.0-beta.3"
