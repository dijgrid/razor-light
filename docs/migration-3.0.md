...
<ItemGroup>
  <PackageReference Include="Dijgrid.RazorLight" Version="3.0.0-beta.4" />
</ItemGroup>
```
...
```xml
<PackageReference Include="Dijgrid.RazorLight.Html" Version="3.0.0-beta.4" />
```
...
2. Replace the package ID and compile against 3.0.0-beta.4.
